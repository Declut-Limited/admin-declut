...
interface AdminUserColumnCallbacks {
...
export function createAdminUserColumns(
  callbacks: AdminUserColumnCallbacks,
  ...
  return [
    ...
    },
    {
      ...
      header: "Role",
      cell: ({ row }) => (
        <span className="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium bg-[#F4F3FF] text-[#5925DC] dark:bg-indigo-950 dark:text-indigo-400">
          {row.original.role}
        </span>
      ),
    },
